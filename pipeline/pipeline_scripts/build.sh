...
mkdir build
cd build
cmake .. -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="-w -Wno-#pragma-messages" -DVLE_SOLVERS_BUILD_TESTS=ON -DCMAKE_INSTALL_PREFIX="$INSTALL_DIR" > ${LOG_DIR}/${LOG_NAME} 2>&1
